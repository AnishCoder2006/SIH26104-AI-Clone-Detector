        ...
        <div className="w-full lg:w-7/12 flex flex-col gap-6">
          ...
          <div className="rounded-2xl p-6 sm:p-8 bg-[#0E1526]/80 border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.5)] backdrop-blur-md relative overflow-hidden group hover:border-primary/40 transition-all duration-300">
            <div className="flex items-center justify-between mb-5">
              ...
              <div className="rounded-xl p-4 bg-[#070B14]/90 border border-white/10 flex flex-col justify-between hover:border-primary/50 transition-all">
                ...
                <div className="h-[140px] rounded-xl bg-[#09111E] border border-white/10 p-4 flex items-center justify-between gap-3 relative overflow-hidden mb-4">
                  ...
                  <div className="relative w-28 h-28 shrink-0 flex items-center justify-center">
                    <img src="/india-map.svg?v=2" alt="India Map" className="w-full h-full drop-shadow-[0_0_10px_rgba(0,245,160,0.35)] object-contain" />
                  </div>
              ...
              <div className="rounded-xl p-4 bg-[#070B14]/90 border border-white/10 flex flex-col justify-between hover:border-[#00D2FF]/50 transition-all">
                {/* Visual Graphic: Exact Wireframe Globe & Stacked Frequency Panels */}
                <div className="h-[140px] rounded-xl bg-[#09111E] border border-white/10 p-4 flex items-center justify-between gap-3 relative overflow-hidden mb-4">
                  {/* Left: Authentic Wireframe Globe with Matrix Dots & Blue Glow */}
                  <div className="relative w-28 h-28 shrink-0 flex items-center justify-center drop-shadow-[0_0_10px_rgba(0,210,255,0.4)]">
