    ...
    <div className="flex flex-col items-center justify-center h-full p-8 bg-slate-900/50 rounded-2xl border border-slate-800 relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center w-full max-w-md">
        ...
        <button
          ...
          className={`w-32 h-32 rounded-full flex items-center justify-center shadow-lg transition-all ${isRecording ? 'bg-red-500/20 text-red-400 border-2 border-red-500 hover:bg-red-500/30'
